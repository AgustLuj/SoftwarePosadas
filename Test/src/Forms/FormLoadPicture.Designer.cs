...
namespace Program.Forms
{
	partial class FormLoadPicture
	{
		...
		private void InitializeComponent()
		{
			...
			this.btn_savepic = new MaterialSkin.Controls.MaterialFlatButton();
			...
			this.btn_crop.Location = new System.Drawing.Point(43, 428);
			...
			// btn_savepic
			// 
			this.btn_savepic.Depth = 0;
			this.btn_savepic.Icon = null;
			this.btn_savepic.Location = new System.Drawing.Point(50, 463);
			this.btn_savepic.Margin = new System.Windows.Forms.Padding(4, 6, 4, 6);
			this.btn_savepic.MouseState = MaterialSkin.MouseState.HOVER;
			this.btn_savepic.Name = "btn_savepic";
			this.btn_savepic.Primary = false;
			this.btn_savepic.selected = false;
			this.btn_savepic.Size = new System.Drawing.Size(75, 23);
			this.btn_savepic.TabIndex = 17;
			this.btn_savepic.Text = "Guardar";
			this.btn_savepic.UseVisualStyleBackColor = true;
			this.btn_savepic.Click += new System.EventHandler(this.Btn_savepicClick);
			// 
			// FormLoadPicture
			// 
		...
		private MaterialSkin.Controls.MaterialFlatButton btn_savepic;
